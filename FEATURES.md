...
#### 📋 게시판 디렉토리
- **카드형 레이아웃**: 모든 게시판을 한눈에 볼 수 있는 카드 형태의 목록
- **반응형 디자인**: 모바일에서도 깔끔하게 보이는 그리드 시스템
- **자동 생성**: 게시판 추가 시 자동으로 목록에 반영
...
#### 📜 정책 페이지 및 자동 설치
- **자동 설치**: 설치 시 4개 국어(한/영/일/중) 이용약관 및 개인정보처리방침 자동 등록
- **다국어 자동 표시**: 사용자 언어 설정에 맞춰 해당 언어의 정책 자동 표시
- **이용약관**: 서비스 이용약관 작성/수정
