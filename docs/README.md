...
Configure OAuth providers directly from the admin panel. Social login buttons automatically appear when configured and enabled.

## 📖 Documentation Updates

This documentation is automatically deployed from the `docs/` folder in the main repository.
