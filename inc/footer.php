        ...
        <div class="footer-container">
            <div class="footer-content">
                <div class="footer-section">
                    ...
                    <p><a href="../about.php" style="color: #ccc; text-decoration: none; font-size: 0.9em;"><?php echo $lang['about_microboard']; ?></a></p>
                </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="copyright">
                    &copy; <?php echo date('Y'); ?> MicroBoard. <?php echo $lang['version']; ?> <?php echo defined('MICROBOARD_VERSION') ? MICROBOARD_VERSION : '1.0.0'; ?>.
                </div>
            </div>
        </div>
    </footer>
